...
# device2: app_key = '4867A28A1DD189110D1A60B05D438AEC'
# device1: app_key = 'AE4A3D8CD4C8D4A747E4DECC91C51EC7'
app_key = '4867A28A1DD189110D1A60B05D438AEC'
# app_key = 'AE4A3D8CD4C8D4A747E4DECC91C51EC7'
...
# in ms
# wait_time_to_send_next_packet = 1000
msg = "Hello World!" # 12 bytes
filename = "two_node_50_msg.csv"
file = open(filename, 'w')
file.write("Msg_Id,message\n")
count = 1
# Send example data
print("sending messages")
while (count < 51):
    send_message(msg)
    file.write("{count},{message}\n".format(count=count, message=msg))
    count+=1
    # send_hex("00 11 22 33 44 55 66 77 88 99 AA BB CC DD EE FF")
    # sleep_ms(wait_time_to_send_next_packet+offset)
file.close()